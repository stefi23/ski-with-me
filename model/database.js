...
con.connect(function (err) {
  ...
  let sql =
    "DROP TABLE if exists user; CREATE TABLE users(id INT NOT NULL AUTO_INCREMENT, first_name VARCHAR(40) NOT NULL,last_name VARCHAR(40)  NOT NULL, sport VARCHAR(40) NOT NULL, CONSTRAINT sport_check CHECK (sport in ('ski', 'both','snowboard')), level varchar(255) NOT NULL, CONSTRAINT level_check CHECK (level in ('pro', 'beginner','medium')), password TEXT NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY (id));";
